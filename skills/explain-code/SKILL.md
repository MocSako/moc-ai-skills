---
name: explain-code
description: Analyzes and explains code functionality systematically — from high-level overview down to line-by-line logic, algorithms, data structures, error handling, performance, and language-specific patterns. Tailors depth to the code being analyzed.
